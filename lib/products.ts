...
export const products: Product[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: '/images/products/london/01.jpg', alt: 'London hookah, red telephone-box form with clear glass base on a dark ground' },
      { src: '/images/products/london/02.jpg', alt: 'London hookah, telephone-box form from an alternate angle with velvet-touch hose' },
      { src: '/images/products/london/03.jpg', alt: 'London hookah, detail of the machined column and fittings' },
      { src: '/images/products/london/04.jpg', alt: 'London hookah, close detail of the telephone-box form' },
    ],
    featured: false,
    order: 4,
  },
  {
    ...
    gallery: [
      { src: '/images/products/shakespeare-lounge/01.jpg', alt: 'Shakespeare Lounge hookah, wooden stem and clear glass base on a dark ground' },
      { src: '/images/products/shakespeare-lounge/02.jpg', alt: 'Shakespeare Lounge hookah, alternate angle of the wooden stem' },
      { src: '/images/products/shakespeare-lounge/03.jpg', alt: 'Shakespeare Lounge hookah, detail of the fittings and hose' },
      { src: '/images/products/shakespeare-lounge/04.jpg', alt: 'Shakespeare Lounge hookah, close detail of the base' },
    ],
    featured: false,
    order: 5,
  },
