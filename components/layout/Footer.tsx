      ...
      <Container as="div" className="py-20 md:py-28">
        <div className="grid gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-md text-balance font-serif text-3xl font-light leading-tight text-ivory">
              Join the Connoisseur Circle
            </p>
            <p className="mt-4 max-w-md text-pretty text-sm text-ivory-muted">
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:col-span-5 lg:col-start-8">
            {footerNav.map((col) => (
              <nav key={col.heading} aria-label={col.heading}>
                <p className="eyebrow mb-5 text-ivory-faint">{col.heading}</p>
            ...
            <nav aria-label="Elsewhere">
              <p className="eyebrow mb-5 text-ivory-faint">Elsewhere</p>
              <ul className="space-y-3">
                <li>
                  <a
        ...
        <div className="mt-20 flex flex-col gap-6 border-t border-hairline pt-8 md:flex-row md:items-center md:justify-between">
          <p className="font-serif text-lg font-light tracking-[0.18em] text-ivory">
            SMOKE CONNOISSEUR
            <span className="ml-3 align-middle text-xs uppercase tracking-[0.2em] text-brass">
              {site.tagline}
            </span>
          </p>
          <p className="text-xs uppercase tracking-[0.16em] text-ivory-faint">
